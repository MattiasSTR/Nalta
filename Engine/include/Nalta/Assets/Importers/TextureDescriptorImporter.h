...
namespace Nalta
{
    // Imports .texture descriptor files
    class TextureDescriptorImporter final : public IAssetImporter
    {
    public:
        ...
        [[nodiscard]] std::string GetName() const override { return "TextureDescriptorImporter"; }
    };
}